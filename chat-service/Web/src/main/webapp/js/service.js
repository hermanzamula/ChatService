...
ChatService.prototype.setUsername = function (userData) {
...
ChatService.prototype.startReceivePrivateMessage = function () {
    ...
    setTimeout(function () {
                instance.postJSON(instance, "/messages/private/receive/", instance.userData, function (data) {
                    ...
                    instance.triggerGetPublicMessageResponse(response);
                });
            }
            , 1000);
};
...
ChatService.prototype.triggerGetMessageResponse = function (responseData) {
    $(document).trigger(Events.PUBLIC_MESSAGE_RESPONSE, [responseData]);
};

ChatService.prototype.triggerGetPrivateMessageResponse = function (responseData) {
